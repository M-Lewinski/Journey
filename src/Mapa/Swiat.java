...
public class Swiat extends ObiektGraficzny {
    ...
    public void stworzSwiat(){
        ...
        LotniskoCywilne airlineTycoon = new LotniskoCywilne("Airline Tycoon",30,30,50,600,false,10);
        ...
        LotniskoWojskowe cia = new LotniskoWojskowe("CIA",30,30,50,175,false,10);
        ...
        Skrzyzowanie skrzyzowanie4 = new Skrzyzowanie("S:PO-WSI",30,30,300,405,false);
